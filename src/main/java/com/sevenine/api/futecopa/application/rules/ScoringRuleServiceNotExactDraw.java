...
@Component
public class ScoringRuleServiceNotExactDraw implements ScoringRuleService<Object, Integer> {
    ...
    public Integer execute(Object... objects) {
        ...
        return rules.stream().filter(object -> object instanceof ScoringRuleServiceLooserScore).findAny().orElseThrow()
                .execute(report);
    }
